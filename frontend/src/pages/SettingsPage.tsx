...
const EMPTY_BATTERY: BatteryForm = {
  ...
  inverterAcCapacityKw: 0, inverterAcCapacityMargin: 0.05,
};
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      ...
      const bat: BatteryForm = {
        ...
        inverterAcCapacityKw: bat_s.inverterAcCapacityKw ?? 0,
        inverterAcCapacityMargin: bat_s.inverterAcCapacityMargin ?? 0.05,
      };
      setBatteryForm(bat);
    ...
    try {
      await api.patch('/api/settings', {
        battery: {
          ...
          inverterAcCapacityKw: batteryForm.inverterAcCapacityKw,
          inverterAcCapacityMargin: batteryForm.inverterAcCapacityMargin,
          temperatureDerating: {
